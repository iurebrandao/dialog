...
class Pinger(object):
    ...
    def __init__(self, target_host, count, timeout):
...
if __name__ == '__main__':
    ...
    parser.add_argument('count', action="store", help=u'count')
    parser.add_argument('timeout', action="store", help=u'timeout')
    given_args = parser.parse_args()  
    target_host = given_args.host
    count = given_args.count
    timeout = given_args.timeout
    pinger = Pinger(target_host=target_host, count=count, timeout=timeout)
    pinger.ping()